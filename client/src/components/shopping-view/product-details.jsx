            ...
            <DialogContent className="grid grid-cols-2 gap-8 sm:p-12 max-w[90vw] sm:max-w[80vw] lg:max-w-[70vw]">
                ...
                <div className="">
                    ...
                    <div className="mt-5 mb-5">
                        <Button
                            disabled={productDetails?.totalStock === 0 || quantityInCart >= productDetails?.totalStock}
                            className="w-full"
                            onClick={() => handleAddtoCart(productDetails?._id)}>
                            {productDetails?.totalStock === 0
                                ? "Out of stock"
                                : (Array.isArray(cartItems?.items) && cartItems.items.find(item => item.productId === productDetails?._id)?.quantity >= productDetails?.totalStock)
                            ...
                            <div className="flex gap-4">
                                ...
                                <div className="grid gap-1">
                                    <div className="flex items-center gap-2">
                                        <h3 className="font-bold">Jigs Ipong</h3>
                                    </div>
                                    <div className="flex items-center gap-0.5">
                                        <StarIcon className="w-5 h-5 fill-primary" />
                                        <StarIcon className="w-5 h-5 fill-primary" />

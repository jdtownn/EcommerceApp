...
import { BabyIcon, ChevronLeftIcon, ChevronRightIcon, CloudLightning, Footprints, Shirt, ShirtIcon, UmbrellaIcon, WatchIcon } from 'lucide-react';
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <section className='py-12 bg-gray-50'>
                <div className='container mx-auto px-4'>
                    ...
                    <div className='grid gird-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4'>
                        {
